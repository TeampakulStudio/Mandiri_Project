            ...
            <div class="col-md-6">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Data Approve Detail</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-4 control-label">Waktu Approve</label>
                      <label class="col-sm-1">:</label>
                      <label for="inputEmail3" class="col-sm-7 control-label"><?= $order->waktu_acc; ?></label>
                    </div>
                    <div class="form-group">
