...
<ul id="tt1" class="easyui-tree" data-options="animate:true,dnd:true">
   ...
   <li data-options="iconCls:'icon-home'">
        <span><a href="javascript:void(0)" onclick="addPanel1()">Home</a></span>
    </li>
    <li data-options="iconCls:'icon-master'">
        ...
        <ul>
            ...
            <li data-options="iconCls:'icon-barang'"><a href="javascript:void(0)" onclick="addPanel()">Data Order</a></li>
  ...
  <script type="text/javascript">
    ...
    function addPanel(){
     ...
     function addPanel1(){
      ...
      $('#tt').tabs('add',{
        title: 'Home',
        href: '<a href="<?= base_url(); ?>Operatorbu/data',
        closable: true
      });
    }
